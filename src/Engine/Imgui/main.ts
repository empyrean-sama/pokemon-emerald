...
async function _init(): Promise<void> {
    ...
    // font = await AddFontFromFileTTF(fira, 14.0);
    // font = await AddFontFromFileTTF(proggyCLeanURL, 16.0);
...
function _loop(time: number): void {
    ...
    // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
    {
        ...
        ImGui.Begin("Hello, worlds!");                          // Create a window called "Hello, world!" and append into it.
