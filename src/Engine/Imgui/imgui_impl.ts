                        ...
                        for (let i = 0; i < draw_cmd.ElemCount; i += 3) {
                            ...
                            if (quad) {
                                if (minmin.uv[0] === maxmax.uv[0] || minmin.uv[1] === maxmax.uv[1]) {
                                    ...
                                    const width = image instanceof HTMLVideoElement ? image.videoWidth : image instanceof VideoFrame ? image.displayWidth : image.width as number;
                                    const height = image instanceof HTMLVideoElement ? image.videoHeight : image instanceof VideoFrame ? image.displayHeight : image.height as number;
